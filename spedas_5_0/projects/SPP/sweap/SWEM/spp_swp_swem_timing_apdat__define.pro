...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_5_0/projects/SPP/sweap/SWEM/spp_swp_swem_timing_apdat__define.pro $

function spp_swp_swem_timing_oper_decom,ccsds_data
...
function spp_swp_swem_timing_apdat::decom ,ccsds,  source_dict=source_dict  ;,header,ptp_header=ptp_header   ;,apdat=apdat
  ...
  str = spp_swp_swem_timing_oper_decom(ccsds_data)
...
function spp_swp_swem_timing_apdat::init,apid,name,_extra=ex
  valid = self->spp_gen_apdat::Init(apid,name,EXTRA=ex)
...
pro  spp_swp_swem_timing_apdat__define
  void = {spp_swp_swem_timing_apdat, $
