...
function cdf_tools::sw_version
  ...
  sw_hash['cdf_svn_URL'] = '$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_5_0/projects/SPP/COMMON/cdf_tools__define.pro $'
...
pro cdf_tools::write,pathname,cdftags=cdftags,verbose=verbose
  ...
  global_attributes['cdf_svn_URL'] = '$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_5_0/projects/SPP/COMMON/cdf_tools__define.pro $'
  login_info = get_login_info()
